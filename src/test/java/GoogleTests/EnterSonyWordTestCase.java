...
@Test
public class EnterSonyWordTestCase extends TestConfig {

    @Parameters({"baseUrl", "sonyWord", "googleWord", "delay"})
    public void shouldBeSonyPages(String baseUrl, String sonyWord, String googleWord, int delay) {
        ...
        // page after clicking on the search button does not have time to boot fully
